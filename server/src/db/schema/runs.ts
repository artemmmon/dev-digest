...
export const agentRuns = pgTable(
  'agent_runs',
  {
    ...
    /** LLM cost in USD (provider-reported or price-book estimate); null = no data. */
    costUsd: doublePrecision('cost_usd'),
    /** Groups the runs started by one review request; null for older and CI runs. */
  ...
  (t) => ({
    // run history / active runs / latest batch of a PR, newest first
